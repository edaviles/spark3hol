            ...
            Parallel 
                {
                    ...
                    Invoke-WebRequest "https://raw.githubusercontent.com/Bapic/spark3hol/main/base_infra//artifacts/settingsTemplate.json" -OutFile "C:\Temp\settingsTemplate.json"
                    Invoke-WebRequest "https://aka.ms/azdata-msi" -OutFile "C:\Temp\AZDataCLI.msi"
                    Invoke-WebRequest "https://raw.githubusercontent.com/Bapic/spark3hol/main/base_infra/artifacts/DataServicesLogonScript.ps1" -OutFile "C:\Temp\DataServicesLogonScript.ps1"
                    Invoke-WebRequest "https://raw.githubusercontent.com/Bapic/spark3hol/main/base_infra/artifacts/DeploySQLMI.ps1" -OutFile "C:\Temp\DeploySQLMI.ps1"
                    Invoke-WebRequest "https://raw.githubusercontent.com/Bapic/spark3hol/main/base_infra/artifacts/DeployPostgreSQL.ps1" -OutFile "C:\Temp\DeployPostgreSQL.ps1"                    
                    Invoke-WebRequest "https://raw.githubusercontent.com/Bapic/spark3hol/main/base_infra/artifacts/capiStorageClass.yaml" -OutFile "C:\Temp\capiStorageClass.yaml"
                    Invoke-WebRequest "https://raw.githubusercontent.com/Bapic/spark3hol/main/base_infra/artifacts/dataController.json" -OutFile "C:\Temp\dataController.json"
                    Invoke-WebRequest "https://raw.githubusercontent.com/Bapic/spark3hol/main/base_infra/artifacts/dataController.parameters.json" -OutFile "C:\Temp\dataController.parameters.json"
                    Invoke-WebRequest "https://raw.githubusercontent.com/Bapic/spark3hol/main/base_infra/artifacts/SQLMI.json" -OutFile "C:\Temp\SQLMI.json"
                    Invoke-WebRequest "https://raw.githubusercontent.com/Bapic/spark3hol/main/base_infra/artifacts/SQLMI.parameters.json" -OutFile "C:\Temp\SQLMI.parameters.json"
                    Invoke-WebRequest "https://raw.githubusercontent.com/Bapic/spark3hol/main/base_infra/artifacts/postgreSQL.json" -OutFile "C:\Temp\postgreSQL.json"
                    Invoke-WebRequest "https://raw.githubusercontent.com/Bapic/spark3hol/main/base_infra/artifacts/postgreSQL.parameters.json" -OutFile "C:\Temp\postgreSQL.parameters.json"                       
                    Invoke-WebRequest "https://raw.githubusercontent.com/Bapic/spark3hol/main/base_infra/artifacts/wallpaper.png" -OutFile "C:\Temp\wallpaper.png"
                }
        }
